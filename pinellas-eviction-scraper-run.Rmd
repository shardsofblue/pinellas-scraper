...
path_to_large_files <- "data/misc/large-files"
...
```{r}
write.csv(all_cases_fin, path_to_data, "/eviction_cases_financials_january2019_june2020.csv")
write.csv(all_cases_addresses, path_to_data, "/eviction_cases_addresses_january2019_june2020.csv")
...
write.csv(all_cases_detailed, path_to_data, "/eviction_cases_all_january2019_june2020.csv")
...
t <- read_csv(path_to_data, "/eviction_cases_financials_DATERANGE.csv")
...
t <- read_csv(path_to_data, "/eviction_cases_financials_DATERANGE.csv") %>%
  select(-"X1") %>%
  full_join(read_csv(path_to_data, "/eviction_cases_addresses_DATERANGE.csv"), by= c("case_number" = "case_num")) %>%
  select(-"X1")
