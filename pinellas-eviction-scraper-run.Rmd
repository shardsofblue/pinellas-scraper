...
for(i in dates_ls_pos:length(dates_ls)) {
  ...
  # for(j in case_num_pos:4) { # FLAG this is in testing mode
    ...
    address_data <- bind_rows(address_data, get_addresses())
...
```{r}
write.csv(all_cases_basic_clean, "data/eviction_cases_basic_feb2020_june2020.csv")
```
...
```{r}
write.csv(all_cases_fin, "data/eviction_cases_financials_feb2020_june2020.csv")
write.csv(all_cases_addresses, "data/eviction_cases_addresses_feb2020_june2020.csv")
